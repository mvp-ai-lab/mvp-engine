...
description: Review a PR that modifies skill files (SKILL.md, references under skills/). Apply the skill review checklist and output concrete issues, suggestions, and what to keep.
---
...
- The user asks you to review a PR that changes files under `skills/` (e.g. SKILL.md, references/*.md).
...
1. **Identify skill changes**
   - List all files in the PR under `skills/` (any language).
