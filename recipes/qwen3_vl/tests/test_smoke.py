"""Smoke tests for the Qwen3-VL recipe.

The smoke test is gated because the default recipe loads Qwen3-VL 8B and is
intended for an explicit accelerator-backed validation run.
"""
...
def test_smoke(
    ...
    """Run Qwen3-VL smoke validation only when explicitly requested."""
    if not run_smoke:
        pytest.skip("Qwen3-VL 8B smoke test requires --run-smoke and accelerator resources.")
