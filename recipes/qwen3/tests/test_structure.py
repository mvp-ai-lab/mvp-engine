"""Structure tests for the Qwen3 pretrain stage.
...
RECIPE_IMPORT_PATH = "recipes.qwen3"
CONFIG_SCHEMA_MODULE = f"{RECIPE_IMPORT_PATH}.configs.schema"
CONFIG_CLASS_NAME = "Qwen3Config"
...
def test_file_structure():
    """Validate the baseline Qwen3 file layout."""
