"""Smoke tests for the PanguVL recipe."""
...
def test_smoke(
    ...
    """Run PanguVL smoke validation across ``world_size`` spawned workers."""
    if not run_smoke:
        pytest.skip("PanguVL smoke test requires --run-smoke and accelerator resources.")
