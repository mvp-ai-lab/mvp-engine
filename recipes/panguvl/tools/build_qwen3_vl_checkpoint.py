"""Build the PanguVL Qwen3-VL-8B checkpoint.
...
DEFAULT_OUTPUT_DIR = Path("recipes/panguvl/pretrained/Qwen3-VL-8B-Instruct")
...
def write_build_metadata(
    ...
    metadata_path = output_dir / "panguvl_checkpoint_build.json"
