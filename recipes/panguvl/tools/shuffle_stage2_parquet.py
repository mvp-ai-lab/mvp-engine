"""Shuffle PanguVL stage2 parquet shards into globally mixed output shards.

This tool scans ``./data/panguvl/stage2/**/*.parquet``, treats the parquet
...
DEFAULT_INPUT_ROOT = Path("data/panguvl/stage2")
DEFAULT_OUTPUT_ROOT = Path("data/panguvl/stage2_shuffled")
