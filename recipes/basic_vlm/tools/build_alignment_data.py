"""Build Basic VLM alignment data in mvp-dataset JSONL + TAR format.

This script reconstructs the ``openbee_stage1_stage2_mm_only`` style corpus
...
The Basic VLM recipe can consume this directly.
"""
...
DEFAULT_OUTPUT_ROOT = Path("data/openbee/openbee_stage1_stage2_mm_only")
