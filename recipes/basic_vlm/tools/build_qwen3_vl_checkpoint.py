"""Build the Basic VLM Qwen3-VL-8B checkpoint.
...
DEFAULT_OUTPUT_DIR = Path("recipes/basic_vlm/pretrained/Qwen3-VL-8B-Instruct")
...
def write_build_metadata(
    ...
    metadata_path = output_dir / "basic_vlm_checkpoint_build.json"
