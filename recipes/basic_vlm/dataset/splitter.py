"""Raw conversation splitting utilities for the Basic VLM recipe."""
    ...
    def _build_window_sample(
        ...
        *,
        ...
        if isinstance(sample_id, str) and sample_id:
            ...
            window["basic_vlm_split_parent_id"] = sample_id
        window["basic_vlm_split_window_index"] = window_index
        window["basic_vlm_split_window_count"] = window_count
        window["basic_vlm_split_turn_start"] = turn_start
        window["basic_vlm_split_turn_end"] = turn_end
        return window
...
def build_long_conversation_split_assembler(
    ...
    *,
    ...
    """Build a raw-conversation splitter for the Basic VLM dataset pipeline."""
