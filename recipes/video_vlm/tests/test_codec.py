"""Codec patchification tests for the Video VLM recipe."""
...
from recipes.video_vlm.dataset import codec as codec_module
from recipes.video_vlm.dataset.codec import (
    CodecPatchConfig,
