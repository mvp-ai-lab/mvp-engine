"""Packing utilities for the Qwen3 LM recipe."""
...
class PackedSampleAssembler(Assembler):
    ...
    def _assign_pending_to_packs(self) -> list[dict[str, Any] | list[dict[str, Any]]]:
        ...
        while self.pending_samples and made_progress:
            made_progress = False
            indices = range(len(self.pending_samples))
            if is_random:
